    ...
    <div className="rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
        ...
        <TableBody>
            ...
            products.map((product) => {
                ...
                const categoryName = product.category?.[locale] || product.category?.es || (product.category as any);
                ...
                const margin = product.salePrice > 0 && cost > 0 ? ((product.salePrice - cost) / product.salePrice) * 100 : 0;
                ...
                <TableRow key={product.id} className="group hover:bg-slate-50/60 border-gray-50 transition-colors">
                    ...
                    <TableCell className="pl-6 py-3">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="font-bold text-slate-800 text-sm leading-tight">{productName}</div>
                    ...
                    <TableCell>
                        <div className="flex items-center gap-1.5 text-sm text-gray-500">
                            ...
                            <span className="truncate max-w-[120px]" title={primarySupplier ? getSupplierName(primarySupplier.supplierId) : 'N/A'}>
                                {primarySupplier ? getSupplierName(primarySupplier.supplierId) : 'N/A'}
                            </span>
                        </div>
                    </TableCell>
                    ...
                    <TableCell className="text-right">
                        <div className="flex flex-col items-end gap-0.5">
                            ...
                            <span className="text-[11px] text-gray-400 font-medium">
                                {t('price_cost')}: {formatCurrency(cost)}
                            </span>
                        </div>
                    </TableCell>
                    ...
                    <TableCell>
                        <div className="flex flex-col justify-center">
                            <div className={cn("flex items-center gap-2 font-semibold text-sm", 
                                ...
                                <span>{product.stock} <span className="text-xs text-gray-400 font-normal uppercase ml-0.5">{unitText}</span></span>
                            </div>
                            {stockStatus !== 'high' && (
