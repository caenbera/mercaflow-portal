...
export function RuleDialog({ open, onOpenChange, rule, products, productCategories }: { open: boolean, onOpenChange: (open: boolean) => void, rule: RewardRule | null, products: Product[], productCategories: ProductCategory[] }) {
